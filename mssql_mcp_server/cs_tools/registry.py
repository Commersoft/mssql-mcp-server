        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "server": {"type": "string", "enum": ["DEV", "PROD", "PLAY", "LOT", "CSSQL01", "SAVPOL", "TESTGRODNO", "CERES_TEST", "SLGRODNO", "PBS"],
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "server": {"type": "string", "enum": ["DEV", "PROD", "PLAY", "LOT", "CSSQL01", "SAVPOL", "TESTGRODNO", "CERES_TEST", "PBS"],
                               "description": "Target environment (default DEV)."},
                },
