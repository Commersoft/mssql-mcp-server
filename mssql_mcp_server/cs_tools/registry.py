        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "server": {"type": "string", "enum": ["DEV", "PROD", "PLAY", "LOT", "CSSQL01", "SAVPOL", "TESTGRODNO", "CERES_TEST", "SLGRODNO", "PBS", "PBSTEST"],
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "server": {"type": "string", "enum": ["DEV", "PROD", "PLAY", "LOT", "CSSQL01", "SAVPOL", "TESTGRODNO", "CERES_TEST", "PBS", "PBSTEST"],
                               "description": "Target environment (default DEV)."},
                },
